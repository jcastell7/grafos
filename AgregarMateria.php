...
<html class="supernova"><head>
    ...
    <body>
        <form class="jotform-form" action="index.php" method="post" name="form_60758672869677" id="60758672869677" accept-charset="utf-8">
                    ...
                    <li class="form-line" data-type="control_text" id="id_3">
                        <div id="cid_3" class="form-input-wide">
                            <div id="text_3" class="form-html">
                                <p><span style="font-size: 12pt; font-family: 'arial black', sans-serif; color: #000000; background-color: #ffffff;"><strong>Agregar materia:&nbsp;</strong></span>
                                    <br>
                                    <span style="font-size: 12pt; font-family: 'arial black', sans-serif; color: #000000; background-color: #ffffff;">
                                        <?php
                                        $idMateria = $_POST["idMateria"];
                                        if ($idMateria != null || $idMateria != "") {
                                            if ($_SESSION["grafo"]->agregarMateria($idMateria)) {
                                                print_r($_SESSION["grafo"]->getMaterias());
                                                echo"<br>";
                                                echo "La materia se agrego satisfactoriamente";
                                            } else {
                                                print_r($_SESSION["grafo"]->getMaterias());
                                                echo"<br>";
                                                echo"La materia no pudo ser agregada";
                                            } 
                                        } else {
                                            echo"las cajas de texto no pueden estar vacias";
                                        }
?>
                                    </span>
                                </p>
