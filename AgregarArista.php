...
$idVertice1 = $_POST["VerticeOrigen"];
$idVertice2 = $_POST["VerticeDestino"];
                    ...
                    <div id="text_3" class="form-html">
                        <p><span style="font-size: 12pt; font-family: 'arial black', sans-serif; color: #000000; background-color: #ffffff;"><strong>El vertice seleccionado es:&nbsp;</strong></span>
                            ...
                            <span style="font-size: 12pt; font-family: 'arial black', sans-serif; color: #000000; background-color: #ffffff;">
                                <?php
                                echo"<hr><br>";
                                $posicionPuntos= stripos($tiempo, ":");
                                $hora= substr($tiempo, 0,$posicionPuntos);
                                $minutos= substr($tiempo, $posicionPuntos+1, strlen($tiempo));
                                $minutosDecimal=($minutos/60);
                                $tiempoDecimal=$hora+$minutosDecimal;
                                $peso=$distancia/$tiempoDecimal;
                                if ($_SESSION["grafo"]->agregarArista($idVertice1, $idVertice2,$peso)) {
                                    echo"arista agregada satisfactoriamente";
                                } else {
                                    echo "la arista no pudo ser agregada";
                                }
                                echo"<hr><br>";
                                ?>
