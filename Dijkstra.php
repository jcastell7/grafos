...
$comienzo = (string)$_POST["comienzoD"];
$final = (string)$_POST["finalD"];
    ?>
...
<?php
foreach ($grafo->crearNodos() as $key => $value) {
    echo $value;
};
?>
            ]);
...
<?php
//if($grafo->dijkstra($comienzo,$final)!=null){
foreach ($grafo->unirNodosColor($comienzo,$final) as $value) {
    echo $value;
}
//}else{
//    foreach ($grafo->unirNodos() as $value) {
//    echo $value;
//}
//}
...
//            
            ...
            var opciones = {
                ...
                configure: {
                    enabled: false, showButton: true
                }
            };
            // inicializar la vista del grafo
            console.log(contenedor, datos, opciones);
...
<html class="supernova"><head>
    ...
    <body>
        <form class="jotform-form" action="index.php" method="post" name="form_60755735846669" id="60755735846669" accept-charset="utf-8">
            <input type="hidden" name="formID" value="60755735846669" />
            <div class="form-all">
                <ul class="form-section page-section">
                    <?php
                    if($grafo->dijkstra($comienzo,$final) ==null){
                        echo"<li class='form-line' data-type='control_text' id='id_3'>
                        <div id='cid_3' class='form-input-wide'>
                            <div id='text_3' class='form-html'>
                                <p>No hay un recorrido para estos vertices</p>
                            </div>
                        </div>
                    </li>";
                    }
                    ?>
                    <li class="form-line form-line-column form-col-1" data-type="control_button" id="id_1">
            ...
            <input type="hidden" id="simple_spc" name="simple_spc" value="60755735846669" />
            <script type="text/javascript">
                document.getElementById("si" + "mple" + "_spc").value = "60755735846669-60755735846669";
            </script>
        </form></body>
</html>